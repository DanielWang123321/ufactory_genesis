...
def expert_phase_sample_weights(
    ...
    *,
    ...
    """Return BC weights for the expert phases with strict velocity/release limits."""
...
class ScriptedPickPlaceExpert:
    ...
    def __init__(
        ...
        *,
        ...
        release_open_step_m: float = 0.001,
        ...
        self.close_gap_m = float(getattr(env, "gripper_min_command_gap_m", env.gripper_close_gap_m))
    ...
    def __call__(self, observations=None) -> torch.Tensor:
    ...
    def _phase_setpoints(
        ...
        desired[approach, 1] = obj[approach, 1]
        ...
        desired[descend, 1] = obj[descend, 1]

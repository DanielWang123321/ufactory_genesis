...
Use Linux, an NVIDIA GPU, Python 3.12 or 3.13, Genesis World 1.4.2, Quadrants 1.3.0,
...
project's conservative production margin, not a claim that Genesis 1.4.2 always

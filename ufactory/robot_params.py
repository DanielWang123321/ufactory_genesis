...
_HARDWARE_DYNAMICS_KEYS = frozenset({"xarm6_1305", "uf850", "lite6", "xarm7_1305"})
...
def _task_profile(profile: RobotModelSpec) -> TaskProfile:
    ...
    grasp_defaults = {
        ...
        "obj_spawn_lower": [0.28, -0.05, 0.02],
        "obj_spawn_upper": [0.34, 0.05, 0.02],
        "target_spawn_lower": [0.40, -0.12, 0.02],
        "target_spawn_upper": [0.56, 0.12, 0.02],

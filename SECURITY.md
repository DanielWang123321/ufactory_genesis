...
Only the current `0.2.5` development line receives security fixes. This is Alpha robotics software and is not safety-certified.
...
- Real policy deployment is hard-disabled in v0.2.5.
